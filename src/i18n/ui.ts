...
export const ui = {
  ...
  'zh-tw': {
    ...
    'welcome.title': "歡迎來到 SimpleBlog",
    'welcome.detecting': '正在偵測你的時區...',
    'welcome.from': '歡迎來自',
    'welcome.visitor': "的訪客來到 SimpleBlog",
  ...
  'zh-cn': {
    ...
    'welcome.title': "欢迎来到 SimpleBlog",
    'welcome.detecting': '正在检测你的时区...',
    'welcome.from': '欢迎来自',
    'welcome.visitor': "的访客来到 SimpleBlog",
