...
export const ui = {
  'zh-tw': {
    ...
    'welcome.detecting': '正在偵測你的時空位置...',
    'welcome.from': '歡迎來自',
    'welcome.visitor': '的旅人來到 Astro Blog Template',
    ...
    'noCategory.message': '抱歉，這個語言版本目前沒有此分類或標籤的文章。',
    'noCategory.redirecting': '正在帶你回到所有文章...',
  ...
  'zh-cn': {
    ...
    'welcome.detecting': '正在检测你的时空位置...',
    'welcome.from': '欢迎来自',
    'welcome.visitor': '的旅人来到 Astro Blog Template',
    ...
    'cookie.privacyLink': '隐私权政策',
    'cookie.rememberTimezone': '允许本站记住我选择的时区',
    'cookie.enableAnalytics': '允许 Google Analytics (GA4) 收集浏览资料',
    'cookie.save': '保存设置',
    'cookie.close': '关闭',
    'cookie.necessary': 'Cookie / 本地存储设置',

    'noCategory.title': '目前没有相关内容',
    'noCategory.message': '抱歉，这个语言版本目前没有此分类或标签的文章。',
    'noCategory.redirecting': '正在带你回到所有文章...',
    'noCategory.manual': '点此立即前往',
  ...
  en: {
    ...
    'cookie.description': 'This site uses cookies and local storage to enhance your browsing experience.',
