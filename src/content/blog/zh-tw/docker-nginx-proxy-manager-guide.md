...
這個範例使用 Docker 官方便利腳本。若你對供應鏈安全要求較高，建議改用作業系統套件庫或 Docker 官方 APT Repository，並在執行前先檢查腳本內容。
...
services:
  app:
    ...
    ports:
      ...
      - '127.0.0.1:81:81' # NPM 管理介面，僅本機可訪問
...
正式環境建議把 `latest` 改成你實際測試過的固定版本標籤，避免容器重建時自動拉到未驗證的新版本。
